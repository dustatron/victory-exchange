          ...
          <Col md={6} lg={{ span: 6 }} className='row1--center'>
            <div className='row1--center-box'>
              <div className='center-box--top'>
                ...
                <p>Victory Exchage makes it easier for you to see what your neighbors are growing and trade your extra home grown goods.</p>
              </div>
          ...
          <Col className='row2-right' md={8}>
            <div className='row2-right-box'>
              ...
              <p className='victory-text'>
                A vegetable, fruit, and herb gardens planted at private residences and public parks in the United States, United Kingdom, Canada, Australia and Germany during World War I and World War II.{' '}
